<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"C:\wwwroot\lanxi.yz360.com.cn\public/../application/admin\view\product\index\edit.html";i:1574492527;s:72:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\layout\default.html";i:1573268565;s:69:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\common\meta.html";i:1573268565;s:71:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\common\script.html";i:1573268565;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">产品分类:</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-introduce" data-rule="required" class="form-control" name="row[introduce]" type="text" value="<?php echo htmlentities($row['introduce']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">首页显示:</label>
        <div class="col-xs-12 col-sm-8">
                <?php echo build_radios('row[is_index]', ['1'=>__('Normal'), '0'=>__('Hidden')], $row['is_index']); ?>
        </div>
    </div>
