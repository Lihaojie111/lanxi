<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"C:\wwwroot\lanxi.yz360.com.cn\public/../application/admin\view\card\index\edit.html";i:1574492639;s:72:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\layout\default.html";i:1573268565;s:69:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\common\meta.html";i:1573268565;s:71:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\common\script.html";i:1573268565;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">卡片类别:</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">实际到账:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-price" data-rule="required" class="form-control" name="row[shiji]" type="number" value="<?php echo htmlentities($row['shiji']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">添加时间:</label>
        <div class="col-xs-12 col-sm-8">
