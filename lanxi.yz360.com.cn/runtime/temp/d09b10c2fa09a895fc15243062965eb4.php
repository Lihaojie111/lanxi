<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"C:\wwwroot\lanxi.yz360.com.cn\public/../application/admin\view\lunbo\index\edit.html";i:1574643793;s:72:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\layout\default.html";i:1573268565;s:69:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\common\meta.html";i:1573268565;s:71:"C:\wwwroot\lanxi.yz360.com.cn\application\admin\view\common\script.html";i:1573268565;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <input id="c-title" data-rule="required" class="form-control" name="row[en_title]" type="text" value="<?php echo htmlentities($row['en_title']); ?>">
            </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">简介:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-title"  class="form-control" name="row[desc]" type="text" value="<?php echo htmlentities($row['desc']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-cat_id" data-rule="required" class="form-control selectpicker" name="row[type]">
                ...
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" <?php if($row['type'] == $vo['id']): ?>selected = "selected"<?php endif; ?>><?php echo $vo['name']; ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-cat_id" data-rule="required" class="form-control selectpicker" name="row[service_id]">
                <?php if(is_array($serviceList) || $serviceList instanceof \think\Collection || $serviceList instanceof \think\Paginator): if( count($serviceList)==0 ) : echo "" ;else: foreach($serviceList as $key=>$vo): if($row['service_id'] == ''): ?>
                <option  value="0">请选择服务</option>
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" ><?php echo $vo['name']; ?></option>
                <?php else: ?>
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" <?php if($row['service_id'] == $vo['id']): ?>selected = "selected"<?php endif; ?>><?php echo $vo['name']; ?></option>
